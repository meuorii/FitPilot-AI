...
import roccoReference from '../../assets/images/rocco-logout-wave.png'
      ...
      <div className="flex h-full flex-col overflow-y-auto bg-white px-4 py-5">
        ...
        <div className="mt-auto pt-8">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-2xl px-3.5 py-3 text-sm font-semibold text-[#7482A4] transition hover:bg-[#7482A4]/10 hover:text-[#5F6E91] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7482A4] focus-visible:ring-offset-2"
          >
